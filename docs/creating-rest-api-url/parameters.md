...
```
https://us-central1-nfgdatabasedemo.cloudfunctions.net/app/api/invoice\_external?
```
...
<div className={styles.centerButton}>
  <a href="/ipay.postman\_collection.json" download className={styles.downloadButtonIpayPostman}>
...
Settlement is delivered in stablecoins — see \[USDT vs USDC for merchant settlement](https://www.i-pay.io/post/usdt-vs-usdc-for-merchant-settlement-stability-liquidity-compliance).
