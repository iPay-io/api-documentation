...
* **Solution**: Verify the URL matches `https://us-central1-nfgdatabasedemo.cloudfunctions.net/app/api/invoice\_external?`. Check account IDs in the dashboard.
...
Declines carry a real revenue cost — see \[the hidden cost of card decline rates](https://www.i-pay.io/post/hidden-cost-card-decline-rates-high-risk-merchants).
